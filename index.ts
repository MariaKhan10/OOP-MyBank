...
class BankAccount {
    ...
    if (amount <= 100) {
      ...
      console.log(
        chalk.bold.italic.green(
          `Deposited ${amount} successfully. Fee Charged : Rs.0`
        )
      );
    } else if (amount > 100) {
      ...
      console.log(
        chalk.bold.italic.green(
          `Deposited ${amount} successfully. Fee Charged : Rs.1`
        )
      );
    } else {
  ...
  withdraw(amount: number) {
    if (amount > 0 && amount <= this.balance) {
      ...
      console.log(
        chalk.bold.italic.red("Insufficient Funds or Invalid Amount.")
      );
    }
  }
  ...
  checkBalance() {
    console.log(
      chalk.bold.italic.green(`Your balance is: ${this.balance} Rupees.`)
    );
  }
